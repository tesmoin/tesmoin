defmodule TesmoinWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use TesmoinWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import TesmoinWeb.ConnCase
    end
  end

  setup tags do
    Tesmoin.DataCase.setup_sandbox(tags)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Tesmoin.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
