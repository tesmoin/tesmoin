...
config :tesmoin, TesmoinWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:tesmoin, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:tesmoin, ~w(--watch)]}
  ]
...
config :tesmoin, TesmoinWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/tesmoin_web/router\.ex$"E,
      ~r"lib/tesmoin_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :tesmoin, dev_routes: true
